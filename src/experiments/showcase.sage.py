...
# This file was *autogenerated* from the file src/experiments/showcase.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1024 = Integer(1024); _sage_const_10 = Integer(10)
import os
import sys
import argparse
...
def get_parser():
    ...
    parser.add_argument("--num_samples_to_show", type=int, default=_sage_const_10 , help="Number of samples to show")
