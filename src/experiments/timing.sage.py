...
_sage_const_5 = Integer(5); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_100 = Integer(100)
import os, yaml
...
def _timing_algo(dataset, gb_algorithm, verbose=True, timeout_limit=_sage_const_5 , n_jobs=_sage_const_1 ):
    ...
    for i, (F, G) in enumerate(dataset):
        if ideal(F).dimension() != _sage_const_0 : print(F)
        ...
        if verbose and (i+_sage_const_1 ) % _sage_const_100  == _sage_const_0 : print(f'[{i+_sage_const_1 :04d} / {len(dataset)}]', flush=True)
...
def _timing_transformer(dataloader, model, tokenizer, verbose=True):
    ...
    for i, batch in enumerate(dataloader):
        max_length = min(max_length, batch['labels'].shape[_sage_const_1 ] + _sage_const_1 )
        ...
        runtime = end - start
        success = pred[_sage_const_0 ] == target[_sage_const_0 ]
...
def timing_experiment(dataset, dataloader, gb_algorithms, model, tokenizer, verbose=True, timeout_limit=_sage_const_5 ):
