...
# This file was *autogenerated* from the file src/misc/data_converter.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_7 = Integer(7); _sage_const_2 = Integer(2)
import sys 
...
ring =  PolynomialRing(GF(_sage_const_7 ), 'x', _sage_const_2 , order='lex')
...
new_dataset = Parallel(n_jobs=-_sage_const_1 , verbose=True, backend="multiprocessing")([delayed(ont_step)(Fstr, Gstr) for Fstr, Gstr in zip(input_texts, target_texts)])
